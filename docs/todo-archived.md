...
The full delivery records for **completed** tasks. `docs/todo.md` keeps the live backlog and, for
each finished task, a single ticked one-line summary; everything else about it — the decisions, the
rulings, the measured numbers, the things deliberately *not* done and why — lives here.

Split out on 2026-08-04 to keep `docs/todo.md` small, because it is loaded into context every
