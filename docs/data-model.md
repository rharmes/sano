...
Prose, contrast row, table labels and literal glosses are AI-drafted, under Ross's review. Nothing is
scored: "Got it" sets `state.grammarDone[id]` (notes and verb cards alike) and counts toward the streak
like a sound drill.
